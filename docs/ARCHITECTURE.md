...
The optional `web/` React/Vite static frontend is not another backend. It calls the public identification endpoint directly; browser code never contains the admin API key. Its CORS origin is explicitly restricted by `LYRA_ALLOWED_ORIGIN`.
